...
export function register_agent_skills(parent) {
  ...
  tag
    .command("get-api-agent-skills-id-")
  ...
  tag
    .command("get-api-agent-skills-id-raw")
  ...
  tag
    .command("get-api-agent-skills-coverage")
  ...
  tag
    .command("post-api-agent-skills-generate")
