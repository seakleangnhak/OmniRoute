...
export function register_memory(parent) {
  ...
  tag
    .command("post-api-memory-retrieve-preview")
  ...
  tag
    .command("get-api-memory-embedding-providers")
  ...
  tag
    .command("get-api-memory-engine-status")
  ...
  tag
    .command("post-api-memory-summarize")
  ...
  tag
    .command("post-api-memory-reindex")
  ...
  tag
    .command("get-api-settings-memory")
  ...
  tag
    .command("put-api-settings-memory")
  ...
  tag
    .command("get-api-settings-qdrant")
  ...
  tag
    .command("put-api-settings-qdrant")
  ...
  tag
    .command("get-api-settings-qdrant-health")
  ...
  tag
    .command("post-api-settings-qdrant-search")
  ...
  tag
    .command("post-api-settings-qdrant-cleanup")
  ...
  tag
    .command("get-api-settings-qdrant-embedding-models")
