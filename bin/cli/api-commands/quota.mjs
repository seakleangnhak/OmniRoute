...
export function register_quota(parent) {
  ...
  tag
    .command("get-api-quota-pools-id-")
  ...
  tag
    .command("patch-api-quota-pools-id-")
  ...
  tag
    .command("delete-api-quota-pools-id-")
  ...
  tag
    .command("get-api-quota-pools-id-usage")
  ...
  tag
    .command("get-api-quota-plans-connection-id-")
  ...
  tag
    .command("put-api-quota-plans-connection-id-")
  ...
  tag
    .command("delete-api-quota-plans-connection-id-")
  ...
  tag
    ...
    .action(async (opts, cmd) => {
      ...
      if (opts.estimatedRequests != null)
        qs.set("estimatedRequests", String(opts.estimatedRequests));
