...
### Task 18 — Secret scanning local (gitleaks) ➕ _adicionada pela auditoria 6A (2026-06-09)_
...
### Task 19 — Lint + auditoria de segurança dos workflows (actionlint + zizmor) ➕ _adicionada pela auditoria 6A_
...
### Task 20 — License compliance (allowlist SPDX) ➕ _adicionada pela auditoria 6A_
