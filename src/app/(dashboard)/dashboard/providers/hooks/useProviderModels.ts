 ...
 */
export function useProviderModels(providerId: string, connectionId?: string | null): UseProviderModelsResult {
    ...
    const run = async () => {
      ...
      try {
        ...
        const urls = connectionId
          ? [`/api/providers/${encodeURIComponent(connectionId)}/models?refresh=true`, providerModelsUrl]
          : [providerModelsUrl];
