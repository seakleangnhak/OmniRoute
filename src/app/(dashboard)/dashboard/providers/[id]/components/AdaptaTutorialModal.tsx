    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Como conectar o Adapta Web" size="md">
      <div className="flex flex-col gap-5 text-sm">
        <p className="text-text-muted">
          ...
          <code className="bg-surface-2 px-1 rounded font-mono text-xs">__client</code> é um JWT de
          longa duração que permite renovar sessões automaticamente.
        </p>
        ...
        <ol className="flex flex-col gap-4 list-none">
          ...
          <li className="flex gap-3">
            ...
            <div>
              ...
              <p className="text-text-muted mt-0.5">
                Pressione{" "}
                <kbd className="bg-surface-2 px-1.5 py-0.5 rounded text-xs font-mono">F12</kbd> ou{" "}
          ...
          <li className="flex gap-3">
            ...
            <div>
              ...
              <p className="text-text-muted mt-0.5">
                ...
                lista. Clique nele e copie o conteúdo da coluna <strong>Value</strong> — começa com{" "}
        ...
        >
          <strong>Dica:</strong> O cookie <code className="font-mono">__client</code> tem validade
          longa (meses). Só será necessário renová-lo se você sair da conta ou o Adapta invalidar a
          sessão.
        </div>
      </div>
    </Modal>
