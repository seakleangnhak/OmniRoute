    ...
    <section className="flex flex-col gap-5 rounded-xl border border-primary/30 bg-surface p-5">
      ...
      {explainerOpen && (
        <div className="rounded-lg border border-border bg-bg p-4 text-sm text-text-muted">
          <p className="mb-2">
            A compressão reduz <strong className="text-text-main">tokens e custo</strong>{" "}
            reescrevendo o histórico antes de enviar ao provider, preservando o sentido.
          </p>
          <ol className="ml-4 list-decimal space-y-1.5">
            <li>
              <strong className="text-text-main">Token Saver (master)</strong>: precisa estar
              ligado. Desligado, nada é comprimido.
            </li>
            <li>
              <strong className="text-text-main">Modo</strong>: define a estratégia. Os modos
              simples (Lite/Standard/Aggressive/Ultra/RTK) rodam uma única técnica. O modo{" "}
              <strong className="text-text-main">Stacked</strong> roda várias camadas em sequência —
              é o que usa a lista de camadas abaixo.
            </li>
            <li>
            ...
            <li>
              <strong className="text-text-main">Configuração</strong>: cada camada tem liga/desliga
              e parâmetros próprios (botão ⚙).
            </li>
            <li>
              <strong className="text-text-main">Combos nomeados</strong>: salve diferentes
              pipelines e atribua a combos de roteamento específicos (seção abaixo).
            </li>
          </ol>
        </div>
      )}
